...
for (const file of files) {
  ...
  content = content.replace(/text-red-[56]00/g, "text-saffron");
  ...
  content = content.replace(/text-green-600/g, "text-indigo");
  content = content.replace(/text-green-500/g, "text-indigo");
  content = content.replace(/bg-green-[0-9]+/g, "bg-indigo");
  content = content.replace(/bg-green-100/g, "bg-indigo/20");
